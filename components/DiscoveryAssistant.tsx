...
type DebugExportPayload = { sourceUrl: string; generatedAt: string; crawlMetrics: AnalysisLog | null; urlStatus: DiscoveryPageAnalysis[]; pagesCrawled: string[]; productUrls: { discovered: string[]; crawled: string[]; skipped: Array<{ url: string; reason: string }>; skipped_product_urls_due_to_limit: string[] }; debugItems: ExtractionPipelineDebug[] };
