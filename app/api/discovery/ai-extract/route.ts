...
Do not create separate camp rows for care/payment add-ons or variants such as Pre Care, Post Care, Pre + Post Care, Pre+Post Care, Individual Day, Individual Day + Pre Care, Individual Day + Post Care, or Individual Day + Pre+Post Care. Treat those as booking options for the same programme/week/date range. Use one main row per programme/week/date range with the standard full-week base package price where available, and mention add-ons in notes/warnings. Preserve 4-day week wording in camp_name or notes. Keep sold-out visible weeks as rows, with a warning/note if sold out is detected. If activity_type is blank and the page says Childrens Camps or BraveHearts, use "Children's Camps" or "Multi-activity".
